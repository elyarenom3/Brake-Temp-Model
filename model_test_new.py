...
def preprocess_new_data(new_file_path):
...
initial_TBrakeR_value = ...
initial_TBrakeL_value = ...

# Assume initial brake temperatures are known from where we're starting the run
initial_brake_temps = {
        'TBrakeR': initial_TBrakeR_value,  # Replace with actual
        'TBrakeL': initial_TBrakeL_value
}
...
start_point = ...  # where the run begins predicting
n_predictions = len(new_data) - start_point
...
print(predicted_TBrakeR_series, predicted_TBrakeL_series)

# If we have actual values
